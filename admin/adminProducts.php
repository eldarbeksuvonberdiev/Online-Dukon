...
$sql = "SELECT COUNT(*) as count FROM products WHERE user_id='{$_SESSION['id']}'";
...
LEFT JOIN categories ON products.category_id = categories.id WHERE users.id='{$_SESSION['id']}' ORDER BY id DESC LIMIT {$pn},{$limit}";
$result = $con->query($sql);
...
<head>
    ...
    <title>Admin Products control</title>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <label for="editname" class="form-label">
                                                                        <h5 style="font-weight:700"><?= $product['img'] ?></h5>
                                                                    </label>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="editname" class="form-label">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="editorder" name="price" value="<?= $product['price'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="editorder" class="form-label">
                                                                            <h6>Image</h6>
                                                                        </label>
                                                                        <input type="file" class="form-control" id="editorder" name="img">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="editorder" name="count" value="<?= $product['count'] ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="editorder" class="form-label">
                                                                            <h6>Premium or not</h6>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="editorder" name="category" value="<?= $product['category'] ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
