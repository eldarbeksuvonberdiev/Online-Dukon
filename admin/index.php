...
$sql = "SELECT * FROM categories ORDER BY id DESC LIMIT {$pn},{$limit}";
...
<head>
    ...
    <title>Admin Category control</title>
                        ...
                        <form action="createCategory.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="number" class="form-control" name="order" placeholder="Category order">
                                ...
                                foreach ($categories as $category) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#viewModal<?= $category['id'] ?>">
                                                <i class="bi bi-eye"></i>
                                            </button>

                                            <!-- View Modal -->
                                            <div class="modal fade" id="viewModal<?= $category['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <label for="editname" class="form-label">
                                                                        <h5 style="font-weight:700"><?= $category['tr'] ?></h5>
                                                                    </label>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="editname" class="form-label">
                                                                    ...
                                                                    <label for="editname" class="form-label">
                                                                        <h5 style="font-weight:700"><?= $category['active'] ?></h5>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                            ...
                                            <!-- Edit Modal -->
                                            <div class="modal fade" id="editModal<?= $category['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <form action="editCategory.php" method="POST">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="editname" name="editname" value="<?= $category['name'] ?>">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="editorder" class="form-label">
                                                                        <h6>Order</h6>
                                                                    </label>
                                                                    <input type="text" class="form-control" id="editorder" name="edittr" value="<?= $category['tr'] ?>">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="editorder" class="form-label">
                                                                        <h6>Status</h6>
                                                                    ...
                                                                    <select class="form-select" name="editstatus" aria-label="Default select example">
                                                                        <option <?= $category['active'] == "active" ? "selected" : "" ?>>Active</option>
                                                                        <option <?= $category['active'] == "inactive" ? "selected" : "" ?>>Inactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                ...
                                                <div class="modal-dialog">
                                                    <form action="deleteCategory.php" method="POST">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" value="<?= $category['id'] ?>">
                                                                <h4><?= $category['name'] ?> turi o'chirilsinmi?</h4>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
